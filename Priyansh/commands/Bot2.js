...
if ([
 ...
 if ([
    ...
    return api.sendMessage("Kio kia howa, add ho gaya so ho gaya. Ma ap ko kia taqleef hy jnab 👻. Waisay ap bhi khelo na, bot bot! 😄 Atta ki jan kidhar gaye, bechara ro rha us k liye 🥺🤦. Mera owner Attaullah single hai, bolo to number tak de sakta hoon! 😁", threadID);
 }
  ...
  if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
   ...
   if ((event.body.toLowerCase() == "anyone") || (event.body.toLowerCase() == "any")) {
     return api.sendMessage("Main Hun Naw Jaaneman, Aur Mera Boss Attaullah ve edhar he hai ❤️", threadID);
   };

   if ((event.body.toLowerCase() == "atta") || (event.body.toLowerCase() == "Attaullah") || (event.body.toLowerCase() == "priyansh") || (event.body.toLowerCase() == "prince")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞꧁𝗔𝗧𝗧𝗔𝗨𝗟𝗟𝗔𝗛-𝗞𝗛𝗨𝗛𝗔𝗥𝗢꧂☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝔸𝕋𝕋𝔸𝕌𝕃𝕃𝔸ℍ 𝔹𝕆𝕊𝕊🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞https://www.facebook.com/profile.php?id=https://www.facebook.com/sindhi.king.com639 \n👋For Any Kind Of Help Contact On Facebook  Username 👉 @sindhi.king.com639😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽ ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
     return api.sendMessage("He is 𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽. He Gives his name 𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽ everywhare", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "chup ho ja") || (event.body.toLowerCase() == "chup kar")) {
     return api.sendMessage("Nhi rahunga. 😼 Mujhe Bolna H. Tumhe Koi Haq nhi Mujhe Chup Karane ka. Mere boss. 𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽ k elawa koi chup nhi KRWA Sakta mujhe", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Attaullah se bakchodi") || (event.body.toLowerCase() == "Asma Ali se backchodi") || (event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerCase() == "malkin se backchodi")) {
   ...
   if ((event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "naam") || (event.body.toLowerCase() == "owner")) {
     return api.sendMessage("️Name m kya rakkha h. tum kam pe dhyan do.", threadID);
   };

   if ((event.body.toLowerCase() == "bot k bachy") || (event.body.toLowerCase() == "bot ke bache")) {
   ...
   if ((event.body.toLowerCase() == "Attaullah") || (event.body.toLowerCase() == "atta") || (event.body.toLowerCase() == "Atta")) {
    return api.sendMessage("️𝗯𝗼𝘀𝘀 𝗸𝗼 𝘁𝗮𝗻𝗴 𝗻𝗮 𝗸𝗮𝗿𝗼 𝗽𝗹𝘇 🙂", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "🤔") || (event.body.toLowerCase() == "🤨")) {
   ...
   if ((event.body.toLowerCase() == "🥴") || (event.body.toLowerCase() == "🥴")) {
     return api.sendMessage("️Oye nashedi 𝘤𝘩𝘶𝘱 𝘬𝘳 𝘈𝘵𝘵𝘢𝘶𝘭𝘭𝘢𝘩 𝘣𝘰𝘴𝘴 𝘥𝘦𝘬𝘩 𝘭𝘦 𝘨𝘢 𝘸𝘢𝘳𝘯𝘢 𝘮𝘢𝘳 𝘬𝘩𝘢𝘰 𝘨𝘺 😂😂😂", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
   ...
   if ((event.body.toLowerCase() == "🤦🏻‍♂") || (event.body.toLowerCase() == "🤦🏻‍♀")) {
     return api.sendMessage("Are apne muh pe kyu maar rahe ho, Mujhe batao kya huva? 𝘈𝘛𝘛𝘈𝘜𝘓𝘓𝘈𝘏 𝘚𝘈𝘉 𝘛𝘏𝘌𝘒 𝘒𝘙 𝘋𝘌 𝘎𝘈😬", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "kase ho") || (event.body.toLowerCase() == "kaise ho") || (event.body.toLowerCase() == "kese ho ji") || (event.body.toLowerCase() == "how are you") || (event.body.toLowerCase() == "how are you?")) {
...
if ((event.body.toLowerCase() == "🍕")) {
    return api.sendMessage("Kya pizza khane ka man hai ? ATTAULLAH KO BOLO WO KHILA DE GA 🍕", threadID);
};
...
if ((event.body.toLowerCase() == "🥑")) {
 ...
 var msg = {
  body: `╔═━━━━✦🖤✦━━━━═╗
🔥 𝐌𝐘 𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽ 𝐁𝐎𝐓  🔥
╚═━━━━✦🖤✦━━━━═╝
