...
if ([
 ...
 if ([
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "name btao") || (event.body.toLowerCase() == "tere admin ka name kiya hai ?") || (event.body.toLowerCase() == "nam")) {
     return api.sendMessage("️Name m kya rakkha h. tum kam pe dhyan do.", threadID);
   };

   if ((event.body.toLowerCase() == "bot tum shadi karo gy") || (event.body.toLowerCase() == "bot ke bachy")) {
   ...
   if ((event.body.toLowerCase() == "OWNER") || (event.body.toLowerCase() == "𝗔𝗱𝗺𝗶𝗻") || (event.body.toLowerCase() == "botadmin")) {
    return api.sendMessage("️𝐀𝐓𝐓𝐀𝐔𝐋𝐋𝐀𝐇 𝐊𝐇𝐔𝐇𝐀𝐑𝐎😇", threadID);
   };
