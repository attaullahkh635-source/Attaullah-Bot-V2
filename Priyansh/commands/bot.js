...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "atta") || (event.body.toLowerCase() == "Atta jani") || (event.body.toLowerCase() == "Sindhi") || (event.body.toLowerCase() == "Nomi")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞𝕬𝖙𝖙𝖆𝖚𝖑𝖑𝖆𝖍 𝕶𝖍𝖚𝖍𝖆𝖗𝖔☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝔸𝕥𝕥𝕒𝕦𝕝𝕝𝕒𝕙🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ www.facebook.com/attaullah.sindhi.com639\n👋For Any Kind Of Help Contact On Telegram  Username 👉 @attaullah.sindhi😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("Attaullah  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is Attaullah. He Gives his name Attaullah everywhare", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "jey Sindhi") || (event.body.toLowerCase() == "sindhi") || (event.body.toLowerCase() == "Attaullah Sindhi")) {
    return api.sendMessage("️𝐉𝐄𝐘 𝐒𝐈𝐍𝐃𝐇 😇", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Attaullah") || (event.body.toLowerCase() == "atta") || (event.body.toLowerCase() == "nomi") || (event.body.toLowerCase() == "main Attaullah") || (event.body.toLowerCase() == "atta jani")) {
