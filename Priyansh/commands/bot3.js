...
if ([
  ...
  if ([
    ...
    return api.sendMessage("Yaar, Mujhe aisi baatein nahi pasand. Main buhat shreef hoon. Haan, mera owner 𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽ single hai, bolo to number tak de sakta hoon. 😁", threadID);
  }
 if ([
    "bot i miss you", 
    "i miss you bot", 
    ...
    return api.sendMessage("Hyeee, I miss you too! SuChi kia karun, ID issue aa jata hai is liye mujhe new ID banne ka wait karna padta hai. Jab new ID banti hai, to mera  owner 𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽ mujhe add kar deta hai. 😅", threadID);
}
 if ([
    "bot kis na add kiya", 
    "bot kisne add kiya", 
    ...
    return api.sendMessage("Kio kia howa, add ho gaya so ho gaya. Ma ap ko kia taqleef hy jnab 👻. Waisay ap bhi khelo na, bot bot! 😄 Mera owner 𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽ single hai, bolo to number tak de sakta hoon! 😁", threadID);
 }
  ...
  if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
   ...
   if ((event.body.toLowerCase() == "Attaullah") || (event.body.toLowerCase() == "Atta") || (event.body.toLowerCase() == "atta") || (event.body.toLowerCase() == "Attaullah Khuharo")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞꧁𝐀𝐭𝐭𝐚𝐮𝐥𝐥𝐚𝐡-𝐊𝐡𝐮𝐡𝐚𝐫𝐨꧂☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝔸𝕋𝕋𝔸𝕌𝕃𝕃𝔸ℍ 𝕊𝕀ℕ𝔻ℍ𝕀🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞https://www.facebook.com/profile.php?id=attaullah.sindhi.com639\n👋For Any Kind Of Help Contact On Facebook  Username 👉 @attaullah.sindhi.com639😇", threadID);
   };

   if ((event.body.toLowerCase() == "bot tumhe kis ne bnaya ? ") || ((event.body.toLowerCase() == "bot tera owner kon hai ? ") || (event.body.toLowerCase() == " bot tumko banaya kisne")) || ((event.body.toLowerCase() == "bot tumhe kis ne bnaya aur owner kon hai ? ")) {
     return api.sendMessage("ATTAULLAH BOSS  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon hai?")) (event.body.toLowerCase() == "bot tera  owner kon hai ?")) {
     return api.sendMessage("He is Attaullah. He Gives his name Atta everywhare", threadID);
   };

   if ((event.body.toLowerCase() == "shadi karoge") || (event.body.toLowerCase() == "mujhse shadi karoge?")) {
     return api.sendMessage("hanji, karunga lekin, Atta Boss se poch kr, baccha. apke pet m hoga. manjur h?", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Attaullah se baqwas") || (event.body.toLowerCase() == "Atta se baqwas") || (event.body.toLowerCase() == "meri jan Asma Ali se baqwas") || (event.body.toLowerCase() == "boss se bakchodi") || (event.body.toLowerCase() == "baap se batmeezi")) {
     return api.sendMessage("sorry  Boss maaf kr do ab nhi kruga 🥺🙏", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "hm") || (event.body.toLowerCase() == "hmm")) {
     return api.sendMessage("️Hmm Hmm Na Karke Sidha Sidha bolo. Attaullah boss ko, Hey Marry Me🙈", threadID);
   };

   if ((event.body.toLowerCase() == "😢") || (event.body.toLowerCase() == "😭") || (event.body.toLowerCase() == "🥺") || (event.body.toLowerCase() == "🥹")) {
     return api.sendMessage("️Kya huva, Ro kyu rahe ho, Attaullah Boss hai na to phir kyu rona. Ruko me abhi chocolate 🍫 deta hu likho ☞Chocolate☜", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "naam") || (event.body.toLowerCase() == " bot name btao apna")) {
     return api.sendMessage("️Name m kya rakkha h. Attaullah Boss ne mna kiya hai, tum kam pe dhyan do.", threadID);
   };

   if ((event.body.toLowerCase() == "bot k bachy") || (event.body.toLowerCase() == "bot ke bachy")) {
   ...
   if ((event.body.toLowerCase() == "Attaullah") || (event.body.toLowerCase() == "ram") || (event.body.toLowerCase() == "ram ram")) {
    return api.sendMessage("️𝗯𝗼𝗹𝗼 𝗷𝗮𝗻 𝗺𝗮𝗶𝗻 𝗵𝗼 𝗻𝗮. 𝗔𝗧𝗧𝗔𝗨𝗟𝗟𝗔𝗛 𝗕𝗢𝗦𝗦 𝗯𝘂𝘀𝘆 𝗵𝗮𝗶 𝘆𝗮𝗿 🙂 𝗷𝗼 𝗯𝗼𝗹𝗻𝗮 𝗵𝗮𝗶 𝗺𝘂𝗷𝗵𝗲 𝗯𝘁𝗮𝗼🙄", threadID);
   };

   if ((event.body.toLowerCase() == "bot bana ke do") || (event.body.toLowerCase() == "mujhe bhi chaiye")) {
     return api.sendMessage("️Khud hi karlona. ya phir mere, Boss Attaullah se bolo bna de ga boss free ho kr.🙄 tumhe kya kuch nhi ata h?", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
   ...
   if ((event.body.toLowerCase() == "ATTAULLAH ALWAYS ALONE") || (event.body.toLowerCase() == "nobody love me") || (event.body.toLowerCase() == "koi pyar nhi karta")) {
   ...
   if ((event.body.toLowerCase() == "bot sad kio ho tum") || (event.body.toLowerCase() == "so sad")) {
     return api.sendMessage("Why can't I be sad because of everyone <3 love you <3", threadID);
   };

   if ((event.body.toLowerCase() == "bot i love you") || (event.body.toLowerCase() == "bot love you")) {
     return api.sendMessage("Yes I love you too baby ummah 😘😘 Mujhe tu tum ne love you bola. ab mere boss, Attaullah ko ve bolo warna mar de ga mujhe 🙂😐", threadID);
   };

   if ((event.body.toLowerCase() == " so jao bot ") || (event.body.toLowerCase() == "bot chup kr ke so jao ab ")) {
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i lob you")) {
   ...
   if ((event.body.toLowerCase() == "&i fuck u") || (event.body.toLowerCase() == "&Fuck of")) {
     return api.sendMessage("🏔️🏝️Attaullah Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
   };
...
if ((event.body.toLowerCase() == "😚")) {
    return api.sendMessage("Awww! Flying kiss de diya 😚. Ab Attaullah Boss gusa ho jaye ga, Mere aur Tere Tharki pan se", threadID);
};
...
if ((event.body.toLowerCase() == "✋")) {
    return api.sendMessage("Sorry Attaullah please chup kr ab  🤦", threadID);
};
...
if ((event.body.toLowerCase() == "🦋")) {
    return api.sendMessage("Aap butterfly ki tarah khubsurat ho! 🦋 lekin mere boss Attaullah se kam 😂🤦", threadID);
};
...
👤 OWNER: 𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽`
};
