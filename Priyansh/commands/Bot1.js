 ...
 if ([
  ...
  if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞꧁𝗔𝗧𝗧𝗔𝗨𝗟𝗟𝗔𝗛꧂☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝔸𝕥𝕥𝕒𝕦𝕝𝕝𝕒𝕙🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞https://www.facebook.com/sindhi.king.com639 \n👋For Any Kind Of Help Contact On Facebook  Username 👉 @sindhi.king.com639😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("Attaullah King  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "Atta se bakchodi") || (event.body.toLowerCase() == "Atta se backchodi") || (event.body.toLowerCase() == "Asma ali se bakchodi") || (event.body.toLowerCase() == "Asma ali se backchodi")) {
     return api.sendMessage("srry boss maaf kr do ab nhi kruga 🥺🙏", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Allah hafiz") || (event.body.toLowerCase() == "Allah") || (event.body.toLowerCase() == "khuda hafiz")) {
    return api.sendMessage("️Allah hafiz take care 😇", threadID);
   };
...
if ((event.body.toLowerCase() == "🫡")) {
    return api.sendMessage("Salute kar rahe ho kya? Atta boss ko😂 🫡", threadID);
};
