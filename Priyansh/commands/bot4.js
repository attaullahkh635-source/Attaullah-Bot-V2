...
module.exports.config = {
  ...
  version: "1.0.1",
  hasPermssion: 0,
  credits: "𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽",
  description: "goibot",
...
if ([
 ...
 if ([
  ...
  if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
   ...
   if ((event.body.toLowerCase() == "Attaullah") || (event.body.toLowerCase() == "𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽") || (event.body.toLowerCase() == "ataa") || (event.body.toLowerCase() == "nomi")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞꧁𓆩𝐈ʈ̊͜͡𝐱'عـَـ̽ـ͜ــطَــ֒اءُالـلّٰـــہْ٘ 𝐉͢ɑ̄̄͜ŋ̽꧂☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝔸𝕥𝕥𝕒𝕦𝕝𝕝𝕒𝕙 𝕁𝕒𝕟𝕚🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞https://www.facebook.com/profile.php?id=attaullah.sindhi.com639 \n👋For Any Kind Of Help Contact On fb  Username 👉 @attaullah.sindhi.com639😇", threadID);
   };

   if ((event.body.toLowerCase() == "bot tumhe kis ne banaya") || (event.body.toLowerCase() == "tujhe bnaya kis ne hai")) {
     return api.sendMessage("Attaullah Khan  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is zain. He Gives his name Attaullah everywhare", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "chup ho ja") || (event.body.toLowerCase() == "chup kar")) {
     return api.sendMessage("Nhi rahunga. 😼 Mujhe Bolna H. Tumhe Koi Haq nhi Mujhe Chup Karane ka. mujhe bas  mera boss Attaullah he chup krwa sakta. M Bolunga", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "sindhi se bakchodi") || (event.body.toLowerCase() == "shut up ") || (event.body.toLowerCase() == "Asma ali se batmeezi") || (event.body.toLowerCase() == "Asma ali se baqwas")) {
     return api.sendMessage("sorry boss maaf kr do ab nhi kruga 🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "gand") || (event.body.toLowerCase() == "gandu") || (event.body.toLowerCase() == "lund") || (event.body.toLowerCase() == "bot k mkc")) {
     return api.sendMessage("Gand m jyada khujli h toh banana 🍌 under le le. :))))", threadID);
   };

   if ((event.body.toLowerCase() == "bot ek chummi de") || (event.body.toLowerCase() == "kiss me")) {
   ...
   if ((event.body.toLowerCase() == "عطاء") || (event.body.toLowerCase() == "عطا") || (event.body.toLowerCase() == "atta")) {
    return api.sendMessage("️جی جان بولو کیا بات ہے؟", threadID);
   };

   if ((event.body.toLowerCase() == "mujhe ve bot chahiye") || (event.body.toLowerCase() == "mujhe bhi chaiye")) {
...
if ((event.body.toLowerCase() == "🌙")) {
    return api.sendMessage("Chand ki roshni mein kho gaye ho? ya boss ko dhond rhy🌙", threadID);
};
